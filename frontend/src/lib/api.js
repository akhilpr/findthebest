...
export const enrichPlace = (id) => api.post(`/enrich/${id}`).then((r) => r.data);
export const fetchSimilar = (id) => api.get(`/places/${id}/similar`).then((r) => r.data);
export const analyzePlace = (payload) => api.post("/analyze", payload).then((r) => r.data);
export const discoverPlaces = (payload) => api.post("/discover", payload).then((r) => r.data);
